...
const TOUR_SLIDES = [
  ...
  { img: '/tour/slide-04.png', module: 'WorkZone',           color: '#0ea5e9', title: 'Master Worksheets Grid',
    bullets: ['Every client × every work type in one grid', 'Status, assignee, due date per cell', 'Grid · Stages · Funnel views — one click'],
    desc: 'WorkZone Worksheets are your master compliance grid. Every client across every work type, one period at a time. Switch between Grid (table), Stages (kanban) and Funnel (stages) views without losing context.' },
  { img: '/tour/slide-05.png', module: 'WorkZone',           color: '#0ea5e9', title: 'Stage-by-Stage Workflow',
    bullets: ['Not Started → Data Collection → Working → Done', 'Drag cards to advance the stage', 'Filter by period, assignee, or work type'],
    desc: 'The Stages view turns compliance work into a visual progress board. Drag client cards through stages: Not Started, Data Collection, Working, Review, Done. See bottlenecks at a glance and re-assign work in seconds.' },
